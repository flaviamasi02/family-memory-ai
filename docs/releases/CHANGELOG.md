...
- Terminal failure presentation retains the most actionable state: absent required model files render `Checkpoint Missing`; generic provider execution or model-load failures render `Failed`; successful verification renders `Ready`.
