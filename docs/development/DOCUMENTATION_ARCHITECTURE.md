...
2. docs/bootstrap/AI_BOOTSTRAP.md
3. docs/bootstrap/COMMANDS.md
4. docs/development/DOCUMENTATION_ARCHITECTURE.md
5. docs/project/PROJECT_CONTEXT.md
6. docs/project/PROJECT_STATE.md
7. docs/development/AI_PROJECT_PLAYBOOK.md
8. docs/development/DECISIONS.md
9. docs/project/ROADMAP.md (if present)
10. Additional referenced mandatory documents
...
- docs/project/ROADMAP.md provides future direction after current-state context is known.
...
| docs/project/PROJECT_CONTEXT.md | Business and product context | Vision, product goals, architecture overview | Sprint-by-sprint implementation status |
...
- `docs/project/`: Product context, operational state, planning, and terminology.
...
- ROADMAP captures planned evolution.

```mermaid
flowchart TD
    H[HANDOVER] --> C[COMMANDS]
