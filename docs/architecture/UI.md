...
The selected-photo workspace presents Preview, Current Status, AI Suggestion, Classification Summary, and Actions as its compact primary flow. Photo Information and Technical details follow as collapsed secondary sections, keeping all primary controls visible without scrolling at normal maximized desktop sizes. Import diagnostics and score explanations remain available on demand. The UI structure does not modify category classification, semantic suggestion, confidence, persistence, sidecar, review-decision, or embedding-cache behavior.
