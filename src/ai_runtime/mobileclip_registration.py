...
def register_mobileclip_runtime(registry: AIRuntimeRegistry) -> None:
    ...
    registry.register('mobileclip', AIRuntimeDescriptor(
        ...
        required_python_packages=(RuntimeDependency('torch','torch>=2.1,<2.4'),RuntimeDependency('torchvision','torchvision>=0.16,<0.19'),RuntimeDependency('PIL','Pillow>=10,<11'),RuntimeDependency('mobileclip','mobileclip @ git+https://github.com/apple/ml-mobileclip.git')),
